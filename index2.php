...
$sql = 'SELECT m.user, m.picture, p.* FROM members m, posts p WHERE m.id=p.member_id LIMIT :start, :list ODER BY m.createdate DESC';
  ...
  <div id="content">
    ...
    <form action="" method="post">
      <dl>
        ...
        <dt><?php echo hsc($member['user']); ?>さん、メッセージをどうぞ</dt>
        <dd>
